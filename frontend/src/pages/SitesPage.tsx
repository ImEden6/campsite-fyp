...
const SitesPage: React.FC = () => {
  ...
  const statusConfig: Record<SiteStatus, { color: string; bgColor: string; label: string }> = {
    ...
    [SiteStatus.OUT_OF_SERVICE]: { color: 'text-secondary-700 dark:text-secondary-300', bgColor: 'bg-secondary-100 dark:bg-night-surface-alt', label: 'Out of Service' },
  };
  ...
  const SiteCard: React.FC<{ site: Site; index: number }> = ({ site, index }) => {
    ...
    return (
      <MotionDiv
        ...
        className="bg-white dark:bg-night-surface rounded-xl shadow-sm border border-gray-200 dark:border-night-surface-alt overflow-hidden hover:shadow-lg transition-all duration-300 group relative"
      >
        {/* Image/Icon Header */}
          ...
          {isAdmin && (
            <div className="absolute bottom-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
              <button
                ...
                className="p-1.5 bg-white dark:bg-night-surface rounded-md shadow-md hover:bg-gray-100 dark:hover:bg-night-surface-alt text-gray-700 dark:text-secondary-200 transition-colors"
                title="Edit site"
              >
              ...
              <button
                ...
                className="p-1.5 bg-white dark:bg-night-surface rounded-md shadow-md hover:bg-red-100 dark:hover:bg-red-900/30 text-red-600 dark:text-red-400 transition-colors"
                title="Delete site"
              >
        ...
        {/* Content */}
        <div className="p-4">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-primary-100 mb-1">
            {site.name}
          </h3>
          <p className="text-sm text-gray-600 dark:text-secondary-400 line-clamp-2 mb-3">
          ...
          {/* Footer */}
          <div className="flex items-center justify-between pt-3 border-t border-gray-200 dark:border-night-surface-alt">
  ...
  const SiteRow: React.FC<{ site: Site; index: number }> = ({ site, index }) => {
    ...
    return (
      <MotionDiv
        ...
        className="bg-white dark:bg-night-surface rounded-lg shadow-sm border border-gray-200 dark:border-night-surface-alt p-4 hover:shadow-md transition-shadow group"
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <h3 className="font-semibold text-gray-900 dark:text-primary-100 truncate">
                {site.name}
              </h3>
            ...
            <p className="text-sm text-gray-600 dark:text-secondary-400 truncate">
              {site.description || 'No description'}
            </p>
          </div>
          <div className="hidden md:flex items-center gap-4">
            <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-secondary-400">
    ...
    return (
      <div className="p-6 max-w-7xl mx-auto">
        <div className="text-center py-12">
          ...
          <p className="mt-4 text-gray-600 dark:text-secondary-400">Loading sites...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="p-6 max-w-7xl mx-auto">
        <Button
          ...
          className="mb-4 flex items-center gap-2 text-gray-700 dark:text-secondary-200"
        >
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-primary-100">
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-primary-100 mb-2">
            Sites Management
          </h1>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
        <div className="bg-white dark:bg-night-surface rounded-lg p-4 border border-gray-200 dark:border-night-surface-alt">
          <p className="text-2xl font-bold text-gray-900 dark:text-primary-100">{stats.total}</p>
          <p className="text-sm text-gray-600 dark:text-secondary-400">Total Sites</p>
        </div>
        <div className="bg-white dark:bg-night-surface rounded-lg p-4 border border-gray-200 dark:border-night-surface-alt">
          <p className="text-2xl font-bold text-green-600 dark:text-green-400">{stats.available}</p>
          <p className="text-sm text-gray-600 dark:text-secondary-400">Available</p>
        </div>
        <div className="bg-white dark:bg-night-surface rounded-lg p-4 border border-gray-200 dark:border-night-surface-alt">
          <p className="text-2xl font-bold text-red-600 dark:text-red-400">{stats.occupied}</p>
          <p className="text-sm text-gray-600 dark:text-secondary-400">Occupied</p>
        </div>
        <div className="bg-white dark:bg-night-surface rounded-lg p-4 border border-gray-200 dark:border-night-surface-alt">
          <p className="text-2xl font-bold text-orange-600 dark:text-orange-400">{stats.cabins}</p>
          <p className="text-sm text-gray-600 dark:text-secondary-400">Cabins</p>
        </div>
        <div className="bg-white dark:bg-night-surface rounded-lg p-4 border border-gray-200 dark:border-night-surface-alt">
          <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{stats.rv}</p>
          <p className="text-sm text-gray-600 dark:text-secondary-400">RV Sites</p>
        </div>
        <div className="bg-white dark:bg-night-surface rounded-lg p-4 border border-gray-200 dark:border-night-surface-alt">
          <p className="text-2xl font-bold text-green-600 dark:text-green-400">{stats.tent}</p>
          <p className="text-sm text-gray-600 dark:text-secondary-400">Tent Sites</p>
        </div>
      </div>

      {/* Search and Filters */}
      <div className="bg-white dark:bg-night-surface rounded-lg border border-gray-200 dark:border-night-surface-alt p-4 mb-6">
        ...
        {/* Filter Options */}
        {showFilters && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 pt-4 border-t border-gray-200 dark:border-night-surface-alt">
            <div>
