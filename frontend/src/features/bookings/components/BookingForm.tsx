 ...
 * Multi-step form for creating a new booking
 */
...
import { createBooking, calculateBookingPrice } from '@/services/api/bookings';
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 p-4 rounded-lg">
                            <p className="text-sm text-gray-900 dark:text-gray-100 font-medium">
                                <strong>Maximum Vehicles:</strong> {site.maxVehicles} | <strong>Current:</strong> {formData.vehicles.length}
                            </p>
                        </div>
                    </div>
                )}
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg p-4 space-y-3">
                            ...
                            {formData.equipmentReservations.length > 0 && (
                                <div className={formData.specialRequests ? 'border-b border-gray-200 dark:border-gray-600 pb-3' : 'pb-3'}>
                                    ...
                                    <p className="text-sm text-gray-900 dark:text-gray-white">{formData.equipmentReservations.length} item(s) selected</p>
                                </div>
                            )}
